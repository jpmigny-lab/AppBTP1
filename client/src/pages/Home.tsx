            ...
            >
              ...
              >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 text-white rounded-2xl font-medium text-lg transition-all border border-white/30 hover:border-white/50 backdrop-blur-sm"
                >
