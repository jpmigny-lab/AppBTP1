      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col gap-6">
            ...
            {onGuestAccess && (
              <p className="animate-element animate-delay-950 text-center text-sm text-white/70 pt-2 border-t border-white/10 mt-4">
                <button type="button" onClick={onGuestAccess} className="text-violet-400 hover:underline transition-colors">
